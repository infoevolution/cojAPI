...
namespace cojApi.Controllers {
    ...
    [ApiController]
    public class cojWorkActivitysController : ControllerBase {
        private readonly cojDBContext _context;
        private CultureInfo _culture;
        public cojWorkActivitysController (cojDBContext context) {
            _context = context;
            _culture = new CultureInfo ("th-TH");

        }

        // GET: api/cojWorkActivitys
        [HttpGet]
        ...
        // GET: api/v1/cojWorkActivitys/GetAll
        [Route ("[action]")]
        [HttpGet]
        ...
        // GET: api/v1/cojWorkActivitys/GetHistory
        [Route ("[action]/{id}")]
        [HttpGet]
        ...
        // GET: api/v1/cojWorkActivitys/searchName
        [Route("[action]/{term}")]
        [HttpGet]
        ...
        // Delete : api/v1/cojWorkActivitys/2 
        [HttpDelete("{id}")]
